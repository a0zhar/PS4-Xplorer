...
public class Opciones : MonoBehaviour {
    ...
    private string CadenaEliminar = "Delete";
    private string CadenaSeguro = "Sure ?";
    ...
    private void Update() {
        ...
        if (Input.GetKeyDown(KeyCode.Joystick1Button0) || Input.GetKeyDown(KeyCode.Keypad2)) {
            switch (Opcion) {
                case 0:Controlador.instancia.NuevaCarpeta();break;
                case 1:Controlador.instancia.Cortar();break;
                case 2:Controlador.instancia.Copiar();break;
                case 3:Controlador.instancia.Pegar();break;
                case 4:Controlador.instancia.Renombra();break;
                case 5:
                if (Controlador.instancia.Seguro) {
