...
public class Controlador : MonoBehaviour {
    ...
    private string CadenaMoviendo = "Moving...";

    private string CadenaCopiando = "Copying...";
    private string CadenaNoHasCopiado = "You have not cut or copied anything to paste";
    private string CadenaErrorCrearCarpeta = "The folder that you try to create already exists";
    ...
    private string FicheroACortar = "";
    private string FicheroACopiar = "";
    ...
    private void ContarFicheros(string origen) {
        string[] files;
    ...
    private IEnumerator MoverDirectorio(string origen, string destino) {
        string[] files;
    ...
    private IEnumerator EliminarDirectorioMovidos(string origen) {
    ...
    private IEnumerator CopiarDirectorio(string origen, string destino) {
        string[] files;
        if (destino[destino.Length - 1] != Path.DirectorySeparatorChar)
            destino += Path.DirectorySeparatorChar;
        if (!Directory.Exists(destino))
    ...
    private IEnumerator MoverFichero(string origen, string destino) {
        yield return null;
    ...
    private IEnumerator CopiarFichero(string origen, string destino) {
        yield return null;
    ...
    private IEnumerator CopiarMultiplesFichero() {
        yield return null;
    ...
    private IEnumerator CortarMultiplesFichero() {
        yield return null;
    ...
    // Opciones avanzadas /////////////////////////////////////////////////////////////////////////////////////////////////////////
    private bool FtpActivado = false;
    private bool FullRwActivado = false;
